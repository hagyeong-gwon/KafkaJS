...
class Producer {
  ...
  /**
  * kafka 메세지 형식에 맞게 데이터를 가공해준다.
  *
  * @param {*} items
  * @param {object} headers
  * @param {string|null} key
  * @param {object[]} messages
  * @return {object[]} [{key: string, headers: object, value: string}]
  */
  ...
  /**
	...
	* @param {string} topic
	* @param {object} headers 메세지 당 넣을 headers (isMakeMsg = true 때 사용)
	* @param {string} key 메세지 당 넣을 key (isMakeMsg = true 때 사용)
